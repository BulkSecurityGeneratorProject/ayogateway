...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/rebate'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Rebate) {
        return item.id;
    }
    registerChangeInRebates() {
        this.eventSubscriber = this.eventManager.subscribe('rebateListModification', (response) => this.loadAll());
    }
