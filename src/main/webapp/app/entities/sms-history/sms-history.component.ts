...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/sms-history'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: SmsHistory) {
        return item.id;
    }
    registerChangeInSmsHistories() {
        this.eventSubscriber = this.eventManager.subscribe('smsHistoryListModification', (response) => this.loadAll());
    }
